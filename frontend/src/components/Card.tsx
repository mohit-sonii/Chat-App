...
function Card({ item }: { item: conversationData }) {
   ...
   return (
      <div className='rounded-lg bg-transparent shadow-lg flex gap-3  items-center border-2 w-full h-max p-2 py-3 border-gray-300 cursor-pointer' onClick={() => { handleClick(item) }}>
