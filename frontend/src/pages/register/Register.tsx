...
export default function Register() {
   ...
   return (
      <div className="flex gap-10 shadow-lg mb-4 rounded-lg border border-gray-300 w-[90%] sm:w-[50%]  md:w-[30%]  justify-center items-center p-4 m-auto ">
         ...
         <form className="w-full m-auto justify-center items-center flex gap-5" onSubmit={handleSubmit}>
            ...
            <div className="flex gap-4 flex-col text-md w-full ">
               <ShadButton type="submit">
                  {loading ? <DotLoader bg='bg-white'></DotLoader> : "Register"}
               </ShadButton>
               <p className="text-slate-800 w-full ">Already have an account?&nbsp;&nbsp;
